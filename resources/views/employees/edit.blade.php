<x-admin-layout>
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-[#0f172a]">Edit Employee</h1>
                <p class="text-[#64748b] text-[14px] mt-1">Update details for {{ $employee->name }}</p>
            </div>
        </div>
        ...
        <div class="card-c max-w-4xl">
            <form action="{{ route('employees.update', $employee) }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group-c">
                                ...
                                <input type="text" name="name" value="{{ old('name', $employee->name) }}" class="form-input-c" required>
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>

                            <div class="form-group-c">
                                <label class="form-label-c">Designation <span class="text-red-500">*</span></label>
                                <input type="text" name="designation" value="{{ old('designation', $employee->designation) }}" class="form-input-c" required>
                                <x-input-error :messages="$errors->get('designation')" class="mt-2" />
                            </div>

                            <div class="form-group-c">
                                <label class="form-label-c">Phone Number</label>
                                <input type="text" name="phone" value="{{ old('phone', $employee->phone) }}" class="form-input-c">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="form-group-c">
                                ...
                                <input type="date" name="joining_date" value="{{ old('joining_date', $employee->joining_date->format('Y-m-d')) }}" class="form-input-c" required>
                            ...
                            <div class="form-group-c">
                                ...
                                <input type="number" step="0.01" name="monthly_salary" value="{{ old('monthly_salary', $employee->monthly_salary) }}" class="form-input-c" required>
                ...
                <div class="px-6 py-4 md:px-8 bg-[#f8fafc] border-t border-[#e5e9f2] flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="btn-brand px-8 py-2.5">Update Employee</button>
                </div>
            </form>
        </div>
    </div>
